  ...
  return(
      <section className={classes.section}>
          {/* <Card className={classes.mainCard}> */}
           {messages.length !== 0 ? messages : <Card><p style={{margin: '5px', fontWeight: 600, color: "rgb(53, 53, 53)"}}>            {isLoading === false ? 'No Replied Messages': "Loading Messages"}</p> </Card>}
         {/* </Card> */}
      </section>
